            ...
            for (var i = 0; i < users.length; i++) {
              ...
              for (var j = 0; j < identifier_reports.length; j++) {
                ...
                */
                ...
                optionElement.setAttribute('value', identifier_report.stage + '|' +  identifier_report.target + '|' + identifier_report.id);
              ...
              for (var j = 0; j < illuminator_reports.length; j++) {
                ...
                */
                ...
                var optionElement = document.createElement('option');
                optionElement.setAttribute('value', illuminator_report.stage + '|' +  illuminator_report.target + '|' + illuminator_report.id);
